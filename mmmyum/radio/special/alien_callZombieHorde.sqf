...
diag_log format ["MMMYUM: ZEDSYSTEM: alien_callZombieHorde SUCCESS! | PositionAgent = %1",_position];
...
_id = [_position,_agent,_posTarget,_mainTarget] execFSM "mmmyum\radio\special\zombie_agentHorde.fsm"; //new zombie agent
_agent